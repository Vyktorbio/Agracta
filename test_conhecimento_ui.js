...
['vendor/dose-core.js','vendor/ativos-en-core.js','vendor/conhecimento-core.js','vendor/avaliacao-core.js','integracoes.js'].forEach(p=>w.eval(fs.readFileSync(p,'utf8')));
