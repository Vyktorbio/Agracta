...
const CACHE = "bioensaio-v44-auditoria";
const SHELL = [
  "./", "./index.html", "./styles.css?v=bioensaio-auditoria-10", "./app.js?v=bioensaio-auditoria-10", "./exemplos.js?v=bioensaio-auditoria-10",
  "./manifest.webmanifest", "./manifest.webmanifest?v=bioensaio-auditoria-10",
