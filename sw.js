...
var ASSETS = [
  ...
  './vendor/conhecimento-core.js?v=1', './vendor/mascara-core.js?v=1', './vendor/croqui-campo-core.js?v=2', './vendor/fontes-core.js?v=1', './vendor/portal-core.js?v=1',
  ...
  './styles.css?v=28', './theme-2026.css?v=8', './ui-campo.css?v=10', './app.js?v=146',
