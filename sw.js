...
var ASSETS = [
  ...
  './styles.css?v=30', './theme-2026.css?v=8', './ui-campo.css?v=11', './app.js?v=159',
  ...
  './acesso-horario.js?v=3', './ui-campo.js?v=20', './alvos-catalogo.js?v=2',
