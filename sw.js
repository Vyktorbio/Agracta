...
var ASSETS = [
  ...
  './styles.css?v=25', './theme-2026.css?v=6', './ui-campo.css?v=8', './app.js?v=89', './mapa-base.jpg',
  './vendor/leaflet.js', './vendor/leaflet.css',
  './vendor/leaflet-rotate.js',
  './vendor/Leaflet.ImageOverlay.Rotated.js',
  './vendor/quadras-default.js', './vendor/biocalc-campo-core.js', './vendor/aplicacao-core.js', './vendor/nutricao-core.js', './vendor/concordancia-core.js', './vendor/dose-core.js', './vendor/biocalc-lab-core.js', './vendor/xlsx.full.min.js', './vendor/jszip.min.js',
