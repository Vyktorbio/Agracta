...
var ASSETS = [
  ...
  './', './index.html',
  './integracoes.css?v=4', './integracoes.js?v=10', './integracoes-fontes.js?v=1', './integracoes-clientes.js?v=1',
  ...
  './styles.css?v=30', './theme-2026.css?v=8', './ui-campo.css?v=11', './app.js?v=160',
  ...
  './acesso-horario.js?v=3', './ui-campo.js?v=21', './alvos-catalogo.js?v=2',
