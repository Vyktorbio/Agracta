...
var ASSETS = [
  ...
  './estudo-pagina.js?v=10', './estudo-pagina.css?v=6',
  /* Vista do campo em 3D: carregada sob demanda pelo estudo-pagina.js, nunca
     ...
     arquivos da lista. */
  './campo-3d.js?v=2', './campo-3d.css?v=2',
