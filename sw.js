...
var CACHE = 'agracta-app-v245';
var PYO_CACHE = 'agracta-pyodide-v1'; /* Pyodide pesado (~115MB) — cache próprio, persiste entre updates do app */
var ASSETS = [
  './interface-neutra.css?v=1', './mesa.css?v=1', './mesa.js?v=2', './mapa-mesa.css?v=1', './mapa-mesa.js?v=1', './clima-pagina.css?v=1', './clima-pagina.js?v=1',
  ...
  './estudo-pagina.js?v=11', './estudo-pagina.css?v=7',
  /* Vista do campo em 3D: carregada sob demanda pelo estudo-pagina.js, nunca
     ...
     arquivos da lista. */
  './campo-3d.js?v=3', './campo-3d.css?v=3',
  ...
  './vendor/conhecimento-core.js?v=1', './vendor/mascara-core.js?v=1', './vendor/fontes-core.js?v=1', './vendor/portal-core.js?v=1',
  ...
  './styles.css?v=27', './theme-2026.css?v=8', './ui-campo.css?v=10', './app.js?v=139',
