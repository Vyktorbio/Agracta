...
var ASSETS = [
  ...
  './styles.css?v=27', './theme-2026.css?v=6', './ui-campo.css?v=8', './app.js?v=96',
  './vendor/leaflet.js', './vendor/leaflet.css',
  './vendor/leaflet-rotate.js',
  './vendor/Leaflet.ImageOverlay.Rotated.js',
  './vendor/quadras-default.js?v=2', './vendor/biocalc-campo-core.js?v=2', './vendor/aplicacao-core.js', './vendor/nutricao-core.js', './vendor/concordancia-core.js', './vendor/dose-core.js?v=3', './vendor/consumo-core.js', './vendor/protocolo-core.js', './vendor/biocalc-lab-core.js', './vendor/supabase.js', './vendor/xlsx.full.min.js', './vendor/jszip.min.js',
