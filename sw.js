...
var ASSETS = [
  ...
  './styles.css?v=22', './theme-2026.css?v=6', './ui-campo.css?v=8', './app.js?v=71', './mapa-base.jpg',
  ...
  './acesso-horario.js?v=2', './ui-campo.js?v=9', './alvos-catalogo.js?v=1',
