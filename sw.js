...
var ASSETS = [
  ...
  './galeria-fotos.js?v=4', './galeria-local.html', './galeria-local.js?v=3', './galeria-local.css?v=1', './vendor/fotos-store.js?v=1', './vendor/fotos-pptx.js?v=1',
