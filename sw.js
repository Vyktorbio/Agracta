...
var ASSETS = [
  ...
  './croqui-parcelas.js?v=1', './croqui-parcelas.css?v=1',
  './profundidade.css?v=1',
  './estudo-pagina.js?v=16', './estudo-pagina.css?v=8',
  ...
  './vendor/conhecimento-core.js?v=1', './vendor/mascara-core.js?v=1', './vendor/croqui-campo-core.js?v=3', './vendor/fontes-core.js?v=1', './vendor/portal-core.js?v=1',
  ...
  './acesso-horario.js?v=3', './ui-campo.js?v=18', './alvos-catalogo.js?v=2',
