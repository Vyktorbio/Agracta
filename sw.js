...
var CACHE = 'agracta-app-v246';
var PYO_CACHE = 'agracta-pyodide-v1'; /* Pyodide pesado (~115MB) — cache próprio, persiste entre updates do app */
var ASSETS = [
  './interface-neutra.css?v=1', './mesa.css?v=1', './mesa.js?v=2', './mapa-mesa.css?v=1', './mapa-mesa.js?v=1', './clima-pagina.css?v=2', './clima-pagina.js?v=2',
  ...
  './styles.css?v=27', './theme-2026.css?v=8', './ui-campo.css?v=10', './app.js?v=140',
