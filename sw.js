...
var ASSETS = [
  ...
  './styles.css?v=27', './theme-2026.css?v=6', './ui-campo.css?v=8', './app.js?v=117',
  ...
  './vendor/firebase-firestore-compat.js', './firebase-config.js', './firebase-sync.js?v=11',
  './acesso-horario.js?v=3', './ui-campo.js?v=15', './alvos-catalogo.js?v=2',
