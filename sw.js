...
var ASSETS = [
  ...
  './styles.css?v=27', './theme-2026.css?v=6', './ui-campo.css?v=8', './app.js?v=116',
  ...
  './acesso-horario.js?v=3', './ui-campo.js?v=14', './alvos-catalogo.js?v=1',
