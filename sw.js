...
var ASSETS = [
  ...
  './galeria-fotos.js?v=6', './galeria-local.html', './galeria-local.js?v=6', './galeria-local.css?v=3', './vendor/fotos-store.js?v=1', './vendor/fotos-pptx.js?v=3',
