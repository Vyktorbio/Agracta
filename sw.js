...
var ASSETS = [
  ...
  './styles.css?v=32', './theme-2026.css?v=9', './ui-campo.css?v=11', './app.js?v=178',
  ...
  './vendor/firebase-firestore-compat.js', './firebase-config.js', './firebase-sync.js?v=16',
