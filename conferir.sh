...
if ! command -v node >/dev/null 2>&1; then
  ...
  for f in vendor/conhecimento-core.js vendor/fontes-core.js vendor/portal-core.js vendor/biocalc-campo-core.js vendor/drone-core.js calculadora-drone.js integracoes.js integracoes-fontes.js integracoes-clientes.js cliente.js app.js estatistica.js firebase-sync.js ui-campo.js mesa.js acesso-horario.js alvos-catalogo.js estatistica/app.js; do
    [ -f "$f" ] || continue
