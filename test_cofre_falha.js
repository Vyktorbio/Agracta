 ...
 * Três garantias:
 *
 *  1. A FALHA APARECE, e o texto identifica a cópia local sem afirmar que
 *     a nuvem está atualizada: pode haver envio pendente ao mesmo tempo.
...
ck(!/nuvem em dia/i.test(SELOS[0][1]),'não confirma a nuvem sem verificar o envio');
...
SELOS=[]; ctx.FB={user:{email:'teste'}}; ctx.document.hidden=true;
